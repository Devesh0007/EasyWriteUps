...
$record_count = $ob->select_data2('select * from posts');
    $per_page = 10;
...
$timeline = $ob->select_data2("select post_id,title, body, category, img, categories.category_id, posted from posts INNER JOIN categories on categories.category_id=posts.category_id order by post_id desc limit $start,$per_page");
$prev = $page-1;
$next = $page+1;
?>
<!DOCTYPE html>
    ...
    <div style="margin-top:80px" class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a style="border-radius:6px;" class="btn btn-primary" href="article.php?id='.$row[0].'"><d style="font-size:14px;">Read More ></d><span class="glyphicon glyphicon-chevron-right"></span></a>
                <p></p>
                <p><span style="color:cadetblue">Category : <a href="category.php?category='.$row[5].'">'.$row[3].'</a></span>&nbsp;&nbsp;&nbsp;<i class="far fa-clock"></i></span>&nbsp;'.$pdate[2].'/'.$pdate[1].'/'.$pdate[0].'</p>
                <hr>';
                        }
                        }
                    }else{
